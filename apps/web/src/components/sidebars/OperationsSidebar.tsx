...
const navItems = [
  ...
  { href: '/operaciones/ordenes-de-servicio', label: 'Órdenes de Servicio', icon: ClipboardList },
  { href: '/operaciones/servicios-activos', label: 'Servicios activos', icon: CalendarClock },
