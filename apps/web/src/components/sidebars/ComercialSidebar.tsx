...
const navItems = [
  { href: '/comercial', label: 'Dashboard', icon: LayoutDashboard, exact: true },
  { href: '/comercial/leads', label: 'Leads', icon: Inbox },
  { href: '/comercial/pipeline', label: 'Pipeline', icon: KanbanSquare },
  { href: '/comercial/clientes', label: 'Clientes', icon: Building2 },
  { href: '/comercial/catalogo', label: 'Catálogo', icon: ListChecks },
  { href: '/comercial/cotizaciones', label: 'Cotizaciones', icon: FileText },
];
