...
export default function VehicleDetailPage({ params }: PageProps) {
  ...
  /* Authenticated download — same pattern as the other detail pages. */
  ...
  return (
    <div>
      ...
      {/* Documentos cargados — listado completo de DocumentRecord para este vehículo */}
      <div className="mt-4">
        <Card>
          <SectionTitle>
      ...
      {/* OPS-027 — published procedures applicable to this vehicle. */}
      <div className="mt-4">
        <ApplicableProcedures assetId={vehicle.assetId} />
      </div>
