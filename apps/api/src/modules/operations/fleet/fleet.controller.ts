...
export class FleetController {
  ...
  findAll(@CurrentCompany() companyId: string, @Query() filters: FilterVehiclesDto) {
    return this.fleetService.findAll(companyId, filters);
  }
  ...
  updateKilometers(
    ...
    @CurrentCompany() companyId: string,
    @CurrentUser() user: { id: string },
    @Body() dto: UpdateKilometersDto,
  ) {
    return this.fleetService.updateKilometers(id, companyId, user.id, dto);
  }
