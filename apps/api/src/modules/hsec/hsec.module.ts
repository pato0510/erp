 ...
 * TrainingsModule (capacitaciones + asistentes + planilla); HSEC-008 EppModule (catálogo +
 * entregas + acuse). PoliciesGuard / CaslAbilityFactory / PrismaService come from the
